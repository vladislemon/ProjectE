...
public class GraphMapperTest {
    ...
    public void setup() {
        ...
        SimpleGraphMapper<String, Fraction, IValueArithmetic<Fraction>> mapper = new SimpleGraphMapper(
            new HiddenFractionArithmetic());
    ...
    public void testGenerateValuesWood() throws Exception {
        ...
        for (char i : "ABCD".toCharArray()) for (char j : "ABCD".toCharArray())
        ...
        for (char i : "ABCD".toCharArray()) for (char j : "ABCD".toCharArray()) mappingCollector
            .addConversion(1, "wooden_hoe", Arrays.asList("stick", "stick", "planks" + i, "planks" + j));
    ...
    public void testGenerateValuesFuelAndMatter() throws Exception {
        ...
        mappingCollector.addConversion(
            1,
            aCoalBlock,
            Arrays.asList(repeat, repeat, repeat, repeat, repeat, repeat, repeat, repeat, repeat));
        ...
        mappingCollector.addConversion(
            1,
            dMatter,
            Arrays.asList(aFuel, aFuel, aFuel, aFuel, aFuel, aFuel, aFuel, aFuel, "diamondBlock"));
        ...
        mappingCollector.addConversion(
            1,
            rMatter,
            Arrays.asList(aFuel, aFuel, aFuel, dMatter, dMatter, dMatter, aFuel, aFuel, aFuel));
    ...
    public void testGenerateValuesWool() throws Exception {
        ...
        for (String dye : dyes) {
            ...
            mappingCollector.addConversion(
                1,
                "painting",
                Arrays.asList("wool" + dye, "stick", "stick", "stick", "stick", "stick", "stick", "stick", "stick"));
        }
    ...
    public void testGenerateValuesChisel2AntiBlock() throws Exception {
        ...
        mappingCollector.addConversion(
            8,
            "antiblockWhite",
            Arrays.asList(stone, stone, stone, stone, gDust, stone, stone, stone, stone));
