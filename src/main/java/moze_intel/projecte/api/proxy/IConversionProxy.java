...
public interface IConversionProxy {
     ...
     * These do not need to be actually Conversions. You can use it to make the EMC value of an item relative to the EMC
     ...
     * <ul>
     * <li>{@link ItemStack} - The ItemId and Metadata will be used to identify this ItemStack (May contain a
     * {@code Block} or {@code Item}). You can use {@link net.minecraftforge.oredict.OreDictionary#WILDCARD_VALUE} as
     * metadata.</li>
     ...
     * <li>{@link FluidStack} - {@link FluidStack#getFluid()} and {@link Fluid#getName()} will be used to identify this
     * Fluid.</li>
     ...
     * object for complex conversion.</li>
     * </ul>
