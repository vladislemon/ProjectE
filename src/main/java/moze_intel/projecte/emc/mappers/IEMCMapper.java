...
public interface IEMCMapper<T, V extends Comparable<V>> {
    ...
    /**
     * The method that allows the IEMCMapper to contribute to the EMC Mapping. Use the methods provided by the
     * {@link IMappingCollector}.
     * <br/>
     ...
     * so you can use {@code ""} (Empty String) as a Category to write into the root-Category that is created for your
     * IEMCMapper.
     * 
     * @param mapper
     * @param config
