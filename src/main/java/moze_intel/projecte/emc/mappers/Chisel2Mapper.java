...
public class Chisel2Mapper implements IEMCMapper<NormalizedSimpleStack, Integer> {
    ...
    protected void handleCarvingGroup(IMappingCollector<NormalizedSimpleStack, Integer> mapper, Configuration config,
        ICarvingGroup group) {
         ...
         * group.getName() + (group.getOreName() == null ? "" : " and oreName=" + group.getOreName())) ) {
         * return;
         * }
         */
